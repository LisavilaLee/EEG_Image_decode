...
vlmodel, preprocess_train, feature_extractor = open_clip.create_model_and_transforms(
    model_type, pretrained=r"E:\BCI\codes\EEG_Image_decode\THINGS\CLIP\open_clip_pytorch_model.bin", precision='fp32', device = device)

import json

# Load the configuration from the JSON file
config_path = "E:\BCI\codes\EEG_Image_decode\Generation4Windows\data_config_windows.json"
